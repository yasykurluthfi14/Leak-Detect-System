                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $data['status_anggaran'] ?></td>
                      <td><a href="#" type="button" class="btn btn-success btn-md" data-toggle="modal" data-target="#edit<?php echo $data['id_dinas']; ?>"><i class="fas fa-edit"></i></a></td>
                    </tr>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="fungsi/edit/edit_anggaran.php" method="POST" enctype="multipart/form-data">
                            ...
                            ?>
                                ...
                                <div class="form-group">
                                    <label for="recipient-name" class="col-form-label">Anggaran yang Diajukan :</label>
                                    <input type="text" required class="form-control" value="<?php echo $row['anggaran']; ?>"  name="anggaran">
                                </div>
                            </div>
