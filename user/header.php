  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="dashboard_user.php" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="before_perjalananDinas.php" class="nav-link">
              <i class="nav-icon fas fa-columns"></i>
              <p>
                Before Perjalanan Dinas
              </p>
            </a>
          </li>
          <li class="nav-item">
            <a href="after_perjalananDinas.php" class="nav-link">
              <i class="nav-icon fas fa-columns"></i>
              <p>
                After Perjalanan Dinas
              </p>
            </a>
          </li>
