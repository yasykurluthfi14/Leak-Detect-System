    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="kelola_timeline.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="kelola_material.php" class="nav-link">
              <i class="nav-icon fas fa-columns"></i>
              <p>
                Kelola Material
              </p>
